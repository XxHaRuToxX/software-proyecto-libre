...
import org.xxharutoxx.views.mainWindow.Calculator;
...
//             if(s.charAt(0) == '√') {
//                 s = s.substring(1);
//                 ans += Math.sqrt(Double.parseDouble(s.charAt(0) + ""));
//             } else {
//                 break;
//             }
//         }
...
//     }
     ...
     */
    public ExpressionCalculate(String s) { // 5 + 4
